...
//var packageBody=createSprite(50,600,10,10)
	...
	bucket3= new 	dustbin(690,600,10,120);
	//ground = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:true} );

 	//World.add(world, ground);
	 ball = Bodies.circle(100 , 450 , 15 , {restitution:0.8, isStatic:false,density:1.2,friction:0.5});
...
function keyPressed(){
	if(keyCode===UP_ARROW)
	Matter.Body.applyForce(ball,ball.position,{x:110,y:30})
}
